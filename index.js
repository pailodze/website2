...
//     this.items = this.element.getElementsByClassName("stack__card");
...
//   var stackCards = document.getElementsByClassName("stack");
...
import {PI, isPrime, array2d} from './js.js';

console.log(PI, isPrime, array2d);